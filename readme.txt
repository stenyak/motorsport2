...
-You can access the online documentation at http://www.motorsport-sim.org/doc/trunk. It's updated pretty often. You can also generate the documentation by yourself if you chdir into the project dirs and then run "doxygen".
